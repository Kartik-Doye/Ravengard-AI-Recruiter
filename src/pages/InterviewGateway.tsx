      ...
      >
        {currentView === 'dashboard' ? (
          ...
          <Routes>
             ...
             <Route path="instructions" element={<ProtectedRoute activeSession={effectiveSession} loading={loading} allowedStage={["interview_instructions", "instructions"]}><InterviewInstructions session={activeSession} onNext={(session) => { setActiveSession(session); }} /></ProtectedRoute>} />
